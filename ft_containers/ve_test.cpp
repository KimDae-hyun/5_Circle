...
int main()
{
    ...
    //     std::vector<std::vector<int> > t1 (3, t);

    //     std::vector<int> t2(4, 4);

    //     t1.pop_back();
    //     t1.push_back(t2);
    //     t1.erase(t);
    //     std::cout << t1[2][0] << std::endl;

    //     for(std::vector<std::vector<int> >::iterator i = t1.begin(); i != t1.end(); i++)
    //     {
    //         for (std::vector<int>::iterator it = t.begin(); it != t.end(); it++)
    //             std::cout << *it << std::endl;
    //         for (std::vector<int>::iterator itt = t2.begin(); itt != t2.end(); itt++)
